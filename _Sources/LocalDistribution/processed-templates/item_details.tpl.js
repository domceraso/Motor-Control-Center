define('item_details.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  buffer += "> "
    ...
    + " </button></div></div><div class=\"item-details-actions-container\"><div data-view=\"ItemDetails.AddToQuote\"></div> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer + " </div></form><div data-type=\"alert-placeholder\" data-role=\"pdp-feedback\"></div></section> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " <div class=\"item-details-more-info-content-container\"><div class=\"content-banner banner-content-top\"></div><div role=\"tabpanel\">  <ul class=\"item-details-more-info-content-tabs\" role=\"tablist\"> ";
  ...
  var stack1, helper, lambda=this.lambda, escapeExpression=this.escapeExpression, functionType="function", helperMissing=helpers.helperMissing, buffer = "  <button class=\"item-details-info-pusher\" data-target=\"item-details-info-"
    ...
    + " <i></i><span class=\"item-details-info-hint\"> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " <div data-cms-area=\"item_info\" data-cms-area-filters=\"path\"></div></div><div class=\"item-details-divider\"></div><div class=\"item-details-image-gallery-container\"><div id=\"banner-image-top\" class=\"content-banner banner-image-top\"></div><div data-view=\"ItemDetails.ImageGallery\"></div><div id=\"banner-image-bottom\" class=\"content-banner banner-image-bottom\"></div></div><div class=\"item-details-divider\"></div><div class=\"item-details-main\"><section class=\"item-details-info\"><div class=\"item-details-banner-summary-bottom\"></div><div data-view=\"Item.Price\"></div><div class=\"item-details-sku-container\"><span class=\"item-details-sku\"> "
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer + " </section><div class=\"item-details-content-related-items\"><div data-view=\"Related.Items\"></div></div><div class=\"item-details-content-correlated-items\"><div data-view=\"Correlated.Items\"></div></div><div class=\"content-banner banner-details-bottom\" data-cms-area=\"item_details_banner_bottom\" data-cms-area-filters=\"page_type\"></div></article></div> ";
