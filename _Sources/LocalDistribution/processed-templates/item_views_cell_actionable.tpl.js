define('item_views_cell_actionable.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return " <a "
    + escapeExpression(((helper = (helper = compilerNameLookup(helpers,"linkAttributes") || (depth0 != null ? compilerNameLookup(depth0,"linkAttributes") : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"linkAttributes","hash":{},"data":data}) : helper)))
    + "><img src=\""
    + escapeExpression(((compilerNameLookup(helpers,"resizeImage") || (depth0 && compilerNameLookup(depth0,"resizeImage")) || helperMissing).call(depth0, ((stack1 = ((stack1 = (depth0 != null ? compilerNameLookup(depth0,"item") : depth0)) != null ? compilerNameLookup(stack1,"_thumbnail") : stack1)) != null ? compilerNameLookup(stack1,"url") : stack1), "thumbnail", {"name":"resizeImage","hash":{},"data":data})))
    + "\" alt=\""
  ...
  return " <a "
    + escapeExpression(((helper = (helper = compilerNameLookup(helpers,"linkAttributes") || (depth0 != null ? compilerNameLookup(depth0,"linkAttributes") : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"linkAttributes","hash":{},"data":data}) : helper)))
    + " class=\"item-views-cell-actionable-name-link\"> "
  ...
  return " <span class=\"item-views-cell-actionable-name-viewonly\">"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? compilerNameLookup(depth0,"item") : depth0)) != null ? compilerNameLookup(stack1,"_name") : stack1), depth0))
    + "</span> ";
},"11":function(depth0,helpers,partials,data) {
  return " <div class=\"item-views-cell-actionable-summary\" data-view=\"Item.Summary.View\"></div> ";
  },"13":function(depth0,helpers,partials,data) {
  return " <div class=\"item-views-cell-actionable-alert-placeholder\" data-type=\"alert-placeholder\"></div> ";
  ...
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, lambda=this.lambda, buffer = " <tr id=\""
    ...
    + "\" data-type=\"order-item\" itemscope itemtype=\"http://schema.org/Product\" ";
  ...
  buffer += "><td class=\"item-views-cell-actionable-table-first\"><div class=\"item-views-cell-actionable-thumbnail\"> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " </div></td><td class=\"item-views-cell-actionable-table-middle\"><div class=\"item-views-cell-actionable-name\"> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " </div><div class=\"item-views-cell-actionable-price\"><div data-view=\"Item.Price\"></div></div><div class=\"item-views-cell-actionable-sku\"><p><span class=\"item-views-cell-actionable-sku-label\">"
    ...
    + "</span><span class=\"item-views-cell-actionable-sku-value\">"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? compilerNameLookup(depth0,"item") : depth0)) != null ? compilerNameLookup(stack1,"_sku") : stack1), depth0))
    + "</span></p></div><div class=\"item-views-cell-actionable-options\"><div data-view=\"Item.SelectedOptions\"></div></div> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " <div class=\"item-views-cell-actionable-stock\" data-view=\"ItemViews.Stock.View\"></div></td><td class=\"item-views-cell-actionable-table-last\"><div data-view=\"Item.Actions.View\"></div> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer + " </td></tr> ";
},"useData":true}); template.Name = 'item_views_cell_actionable'; return template;});