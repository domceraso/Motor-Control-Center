define('order_wizard_cart_summary.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " </span></p></div><div class=\"order-wizard-cart-summary-promocode-applied\"><div data-view=\"CartPromocodeListView\"></div></div> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " <div class=\"order-wizard-cart-summary-shipping-cost-applied\"><p class=\"order-wizard-cart-summary-grid-float\"><span class=\"order-wizard-cart-summary-shipping-cost-formatted\"> "
    ...
    + " </p> ";
  stack1 = compilerNameLookup(helpers,"if").call(depth0, (depth0 != null ? compilerNameLookup(depth0,"showHandlingCost") : depth0), {"name":"if","hash":{},"fn":this.program(11, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += " <p class=\"order-wizard-cart-summary-grid-float\"><span class=\"order-wizard-cart-summary-tax-total-formatted\" > "
    ...
    + " </p></div> ";
  stack1 = compilerNameLookup(helpers,"if").call(depth0, (depth0 != null ? compilerNameLookup(depth0,"showWarningMessage") : depth0), {"name":"if","hash":{},"fn":this.program(13, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
