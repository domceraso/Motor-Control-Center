define('quick_view.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return buffer + " <div data-type=\"alert-placeholder\" data-role=\"pdp-feedback\"></div> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " </button></div></div><div class=\"quick-view-confirmation-modal-actions\"><div data-view=\"ItemDetails.AddToQuote\"></div><div class=\"quick-view-confirmation-modal-add-to-product-list\"><div data-type=\"product-lists-control\" ";
  ...
  var stack1, helper, lambda=this.lambda, escapeExpression=this.escapeExpression, functionType="function", helperMissing=helpers.helperMissing, buffer = " <div class=\"quick-view-confirmation-modal\" itemscope itemtype=\"http://schema.org/Product\"><div class=\"quick-view-confirmation-modal-img\"><div data-view=\"ItemDetails.ImageGallery\"></div></div><div class=\"quick-view-confirmation-modal-details\"><h1 class=\"quick-view-confirmation-modal-item-name\" itemprop=\"name\">"
