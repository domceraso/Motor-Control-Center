...
define('Newsletter.View', [
    'Newsletter.Model', 'SC.Configuration', 'Backbone.FormView', 'Backbone.CompositeView', 'GlobalViews.Message.View'

    , 'newsletter.tpl'

    , 'Backbone', 'underscore', 'jQuery', 'Utils'
], function(
    NewsletterModel, Configuration, BackboneFormView, BackboneCompositeView, GlobalViewsMessageView
    ...
    return Backbone.View.extend({
        ...
        feedback: {
            ...
            'ERROR': {
                'type': 'error',
                'message': _('Sorry, subscription has not been completed. Try again later.').translate()
            }
        }
